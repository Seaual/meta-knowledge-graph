...
interface Props {
  ...
  data?: {
    ...
    category?: string
    paper_count: number
    children?: Array<{id: string; name: string; paper_count?: number; category?: string}>
    parents?: Array<{id: string; name: string; paper_count?: number; category?: string}>
  }
