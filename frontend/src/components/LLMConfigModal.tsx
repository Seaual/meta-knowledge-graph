...
export default function LLMConfigModal({ onClose, onSave }: Props) {
  ...
  const [configType, setConfigType] = useState<"claude_cli" | "custom">(
    "custom"
  );
