        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            <label className="font-mono text-xs text-muted uppercase tracking-wider mb-2 block">
              {t.modal.s2Config.apiKey}{" "}
              {!hasKey && <span className="text-status-error">*</span>}
            </label>
            <input
              type="password"
              value={apiKey}
              ...
              placeholder={
                hasKey
                  ? t.modal.s2Config.enterNew
                  : t.modal.s2Config.apiKeyPlaceholder
              }
              className="input-academic w-full"
            />
            <p className="font-body text-xs text-faint mt-1">
              {t.modal.s2Config.apiKeyHint}:{" "}
              <a
                href="https://www.semanticscholar.org/product/api"
                target="_blank"
                className="text-status-info hover:text-sepia hover:underline"
              >
