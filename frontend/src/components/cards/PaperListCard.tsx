...
export default function PaperListCard({ data, onAction }: Props) {
  ...
  return (
    <div
      className="my-2 rounded-xlarge animate-slide-up overflow-hidden"
      style={{
    ...
    >
      ...
      >
        ...
        {/* Count badge */}
        <span
          className="font-mono text-xs px-2 py-1 rounded-soft"
          style={{
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                {paper.citation_count !== undefined && (
                  <span
                    className="font-mono text-xs px-1.5 py-0.5 rounded-soft"
                    style={{
