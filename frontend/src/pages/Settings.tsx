    ...
    const loadConfig = async () => {
      try {
        ...
        if (res.ok) {
          ...
          // 只保留custom provider
          const customProvider = data.providers?.find(
            (p: any) => p.provider === "custom"
          ) || {
            provider: "custom",
            api_key: "",
            base_url: "",
          ...
          {llmConfig?.providers?.[0] && (
            ...
            >
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label
                    className="block font-mono text-xs uppercase tracking-wider mb-1.5"
              ...
              <button
                ...
                style={{
                  background:
                    testing || !llmConfig.providers[0].api_key
                      ? "var(--color-overlay)"
                      : "var(--color-paper)",
                  border: "1px solid rgba(184, 134, 11, 0.12)",
                  color:
