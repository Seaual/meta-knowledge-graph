...
export const en = {
  ...
  modal: {
    ...
    llmConfig: {
      ...
      baseUrlHint: 'Supports OpenAI/Anthropic official APIs and compatible services',
      apiKey: 'API Key',
      ...
      saving: 'Saving...',
      cliNotice: 'Claude Code CLI is for local development only. Docker environments not supported.',
    },
    // S2 Config
    s2Config: {
    ...
    onboarding: {
      ...
      features: {
        ...
        researchDiscoverDesc: 'Find potential research directions from graph structure',
      },
